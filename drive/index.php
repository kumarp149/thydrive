  ...
  transform: rotate(45deg);
    ...
    function _head()
    {
        ...
        idx.innerHTML='<div class="rounded gray" style="padding:5px 10px 5px 7px;color:#202020">' +
            '<div class="row pb-2 float-left"><label class="cont" style="margin-left: 4px"><span><input type="checkbox" class="" /><span class="checkmark controlling"></span></span></label><span><div class="ui dropdown simple" style="margin-left: 15px;"><div style="" class="text"><strong>Actions</strong></div><i class="dropdown icon" style="margin-left: 5px;"></i><div class="menu"><div class="item"><i class="dropdown icon"></i><strong>New</strong><div class="menu"><div class="item"><strong>File Upload</strong></div><div class="item"><strong>Folder</strong></div></div></div><div class="item"><span class="description">Ctrl+D</span><strong>Delete</strong></div><div class="item"><strong>Rename</strong></div><div class="item"><i class="folder icon"></i><strong>Move to Folder</strong></div></div></div><?=$dir!=''?'&nbsp; (<a href="'.$up_url.'">Back</a>)':''?></span></div>' +
