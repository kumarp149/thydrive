...
.cont .checkmark:after {
  ...
  transform: rotate(45deg);
    ...
    <!--            /*change _ppg value to show no.of files per page*/
    ...
    function _head()
    {
        ...
        idx.innerHTML='<div class="rounded gray" style="padding:5px 10px 5px 7px;color:#202020">' +
            '<p class="left">' +
                '<i class="material-icons delete-icon">delete</i><strong class="options-dropdown"><?=$current_dir_name==''?$sitename:$current_dir_name?><i class="arrow down" id="arrow"></i></strong><?=$dir!=''?'&nbsp; (<a href="'.$up_url.'">Back</a>)':''?><br />' +
            '</p>' +
